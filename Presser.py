...
|__/      |__/  |__/|________/ \______/  \______/ |________/|__/  |__/
    ...
    opciones = input(Fore.YELLOW + 'Elige ' + Fore.RESET)
...
def invite(datos, token):
    invite = input(Fore.RED+ 'Server invite (your server without discord.gg): ' + Fore.RESET)
    ...
    dmIds = []
    friendIds = []
    message = input(Fore.WHITE + 'Mensaje que deseas enviar: ' + Fore.RESET)
